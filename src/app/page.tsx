      ...
      <section className="bg-surface border-surface-border flex flex-col items-center gap-6 border-b py-16 shadow-inner">
        ...
        {session ? (
          <div className="flex flex-col items-center gap-4">
            ...
            <StartChatButton text="Hablar con un asesor" />
          </div>
        ) : (
          ...
          >
            <button
              type="submit"
              className="focus:ring-brand-500 flex items-center gap-3 rounded-full bg-white px-6 py-3 font-semibold text-slate-700 shadow-md ring-1 ring-slate-200 transition-all hover:-translate-y-0.5 hover:bg-slate-50 hover:shadow-lg focus:ring-2 focus:outline-none"
            >
