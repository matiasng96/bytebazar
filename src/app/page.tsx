      ...
      <section className="bg-surface border-surface-border flex flex-col items-center gap-6 border-b py-16 shadow-inner">
        ...
        {session ? (
          ...
          >
            <button
              type="submit"
              className="flex items-center gap-3 rounded-full bg-white px-6 py-3 font-semibold text-slate-700 shadow-md ring-1 ring-slate-200 transition-all hover:-translate-y-0.5 hover:bg-slate-50 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-brand-500"
            >
